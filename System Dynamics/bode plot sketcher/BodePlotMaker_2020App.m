classdef BodePlotMaker_2020App < handle
    %
    % Usage:
    %     app.BodePlotMaker_2020App
    ...
    properties (Constant)
        AppPathBase = {'/BodePlotMaker_2020'};
        AppClass = 'BodePlotMaker_2020App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = BodePlotMaker_2020App()
        ...
        function startApp(obj)
            ...
            mlock;
            BodePlotMaker_2020App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'BodePlotMaker')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong BodePlotMaker
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'BodePlotMaker').getString, ...
            ...
            if nargout(@BodePlotMaker) == 0
                eval('BodePlotMaker');
            else
                obj.AppHandle = eval('BodePlotMaker');
            end
